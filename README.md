...
# Conclusion
We implement a VR Puzzle Game with Blender, Unity and Oculus Rift. The game allows users to grab and assemble the bones to educate them about the skeletal system. In this project, we want to bring a new experience for players so that they can see the learning in a much more intriguing way.
